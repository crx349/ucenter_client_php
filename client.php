...
function uc_feed_add($icon, $uid, $username, $title_template='', $title_data='', $body_template='', $body_data='', $body_general='', $target_ids='', $images = array()) {
	return call_user_func(UC_API_FUNC, 'feed', 'add',
		array(  'icon'=>$icon,
			'appid'=>UC_APPID,
			'uid'=>$uid,
			'username'=>UC_DBCHARSET=='gbk' ? iconv("UTF-8","GB2312//IGNORE",$username) : $username,
...
function uc_user_register($username, $password, $email, $questionid = '', $answer = '', $regip = '') {
	return call_user_func(UC_API_FUNC, 'user', 'register', array('username'=>UC_DBCHARSET=='gbk' ? iconv("UTF-8","GB2312//IGNORE",$username) : $username, 'password'=>$password, 'email'=>$email, 'questionid'=>$questionid, 'answer'=>$answer, 'regip' => $regip));
}

function uc_user_login($username, $password, $isuid = 0, $checkques = 0, $questionid = '', $answer = '', $ip = '') {
	$isuid = intval($isuid);
	$return = call_user_func(UC_API_FUNC, 'user', 'login', array('username'=>UC_DBCHARSET=='gbk' ? iconv("UTF-8","GB2312//IGNORE",$username) : $username, 'password'=>$password, 'isuid'=>$isuid, 'checkques'=>$checkques, 'questionid'=>$questionid, 'answer'=>$answer, 'ip' => $ip));
	return UC_CONNECT == 'mysql' ? $return : uc_unserialize($return);
}
...
function uc_user_edit($username, $oldpw, $newpw, $email, $ignoreoldpw = 0, $questionid = '', $answer = '') {
	return call_user_func(UC_API_FUNC, 'user', 'edit', array('username'=>UC_DBCHARSET=='gbk' ? iconv("UTF-8","GB2312//IGNORE",$username) : $username, 'oldpw'=>$oldpw, 'newpw'=>$newpw, 'email'=>$email, 'ignoreoldpw'=>$ignoreoldpw, 'questionid'=>$questionid, 'answer'=>$answer));
}
...
function uc_user_checkname($username) {
	return call_user_func(UC_API_FUNC, 'user', 'check_username', array('username'=>UC_DBCHARSET=='gbk' ? iconv("UTF-8","GB2312//IGNORE",$username) : $username));
}
...
function uc_user_addprotected($username, $admin='') {
	return call_user_func(UC_API_FUNC, 'user', 'addprotected', array('username'=>UC_DBCHARSET=='gbk' ? iconv("UTF-8","GB2312//IGNORE",$username) : $username, 'admin'=>$admin));
}

function uc_user_deleteprotected($username) {
	return call_user_func(UC_API_FUNC, 'user', 'deleteprotected', array('username'=>UC_DBCHARSET=='gbk' ? iconv("UTF-8","GB2312//IGNORE",$username) : $username));
}
...
function uc_get_user($username, $isuid=0) {
	$return = call_user_func(UC_API_FUNC, 'user', 'get_user', array('username'=>UC_DBCHARSET=='gbk' ? iconv("UTF-8","GB2312//IGNORE",$username) : $username, 'isuid'=>$isuid));
	return UC_CONNECT == 'mysql' ? $return : uc_unserialize($return);
}
...
function uc_user_merge_remove($username) {
	return call_user_func(UC_API_FUNC, 'user', 'merge_remove', array('username'=>UC_DBCHARSET=='gbk' ? iconv("UTF-8","GB2312//IGNORE",$username) : $username));
}
...
function uc_pm_blackls_add($uid, $username) {
	$uid = intval($uid);
	return call_user_func(UC_API_FUNC, 'pm', 'blackls_add', array('uid'=>$uid, 'username'=>UC_DBCHARSET=='gbk' ? iconv("UTF-8","GB2312//IGNORE",$username) : $username));
}

function uc_pm_blackls_delete($uid, $username) {
	$uid = intval($uid);
	return call_user_func(UC_API_FUNC, 'pm', 'blackls_delete', array('uid'=>$uid, 'username'=>UC_DBCHARSET=='gbk' ? iconv("UTF-8","GB2312//IGNORE",$username) : $username));
}
